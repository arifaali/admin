...
<head>
    ...
    <title>Kudumbashree | 360STORE</title>
...
<body>
    ...
    <div class="all-content-wrapper">
        ...
        <?php
   $sql =<<<EOF
   select prod.* from product prod join product_tags as pt on prod.id = pt.product where pt.tag = 2;
EOF;
