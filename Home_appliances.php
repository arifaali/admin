...
<head>
    ...
    <title>Home appliances and crockery Products | 360STORE</title>
...
<body>
    ...
    <div class="all-content-wrapper">
            ...
            <div class="container-fluid">
                <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                        <div class="product-status-wrap">
                            <h2>Home appliances and crockery Products</h2>
                        </div>
                </div>
            </div>
        </div>                    
        ...
        <?php
   $sql =<<<EOF
   select prod.* from product prod join product_tags as pt on prod.id = pt.product where pt.tag = 8;
  EOF;
...
?>
                        ...
                        <div class="sparkline13-list">
                            <div class="sparkline13-hd">
                                <div class="main-sparkline13-hd">
                                    <h1>Home appliances and crockery Products</h1>
                                    <div align="right">
    ...
    <form method="post" id="insert_form" action="insert.php" enctype="multipart/form-data">
     ...
     <br />
     <input type="hidden" id="catId" name="catId" value="8" />
