...
<head>
    ...
    <title>Edit Product | 360STORE</title>
...
<body>
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        ...
                                        <li><a data-toggle="collapse" data-target="#demoevent" href="#">Products <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul id="demoevent" class="collapse dropdown-header-top">
                                                <li><a href="all-products.php">All Products</a>
                                                </li>
                                                <li><a href="add-products.php">Add Products</a>
                                                </li>
                                                <li><a href="edit-products.html">Edit Product</a>
                                                </li>
                                                </li>
                                            </ul>
                                        </li>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Product Information</a></li>
                            </ul>
                                                    ...
                                                    <form action="/upload" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <input name="price_MRP" type="text" class="form-control" placeholder="Price (MRP)">
                                                                </div>
                                                               
                                                                <div class="form-group">
                                                                    <input name="Quantity" id="text" type="text" class="form-control" placeholder="Quantity">
                                                                </div>
                                                                <div class="form-group">
                                                                    <select name="Quantity_type" class="form-control">
																			<option value="none" selected="" disabled="">Qunatity type</option>
                                                            ...
                                                            <div class="form-group res-mg-t-15">
                                                                   <input name="product code" type="text" class="form-control" placeholder="Product Code">
                                                                </div>
                                                                <div class="form-group res-mg-t-15">
                                                                   <input name="offer price" type="text" class="form-control" placeholder="Offer Price">
                                                                </div>
                                                                <div class="form-group res-mg-t-15">
                                                                   <input name="Total_Qunatity" type="text" class="form-control" placeholder="Total Quantity">
                                                                </div>
                                                                <div class="form-group res-mg-t-15">
    ...
    if(isset($_POST['Submit']))
        {
            $id = $_POST['Total_Qunatity'];
            $name = $_POST['productname'];
            $desc = $_POST['description'];
            $price = $_POST['price_MRP'];
            $qty = $_POST['Quantity'];
            $qty_type = $_POST['Quantity_type'];
            $product_image = $_POST['imageico'];
            $mysqli->query("insert into product(id,name,desc,price,qty,qty_type,product_image) values('$id', '$name', '$desc', '$price', '$qty', '$qty_type', '$product_image')");
        if(!$mysqli) 
        { echo mysqli_error(); }
    else
    {
